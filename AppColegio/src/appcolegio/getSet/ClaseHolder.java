...
public class ClaseHolder extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public ClaseHolder(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public ClaseHolder(String text, JTextComponent component, Show show) {
